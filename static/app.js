(function(){
  ...
  function step(){
    ...
    const g1 = ctx.createRadialGradient(mouse.x, mouse.y, 0, mouse.x, mouse.y, r*2.2);
    g1.addColorStop(0, 'rgba(20,184,166,0.50)'); g1.addColorStop(1, 'rgba(20,184,166,0)');
    ctx.fillStyle = g1; ctx.beginPath(); ctx.arc(mouse.x, mouse.y, r*2.2, 0, Math.PI*2); ctx.fill();
    const g2 = ctx.createRadialGradient(mouse.x, mouse.y, 0, mouse.x, mouse.y, r);
    g2.addColorStop(0, 'rgba(124,58,237,0.55)'); g2.addColorStop(1, 'rgba(124,58,237,0)');
    ctx.fillStyle = g2; ctx.beginPath(); ctx.arc(mouse.x, mouse.y, r, 0, Math.PI*2); ctx.fill();
